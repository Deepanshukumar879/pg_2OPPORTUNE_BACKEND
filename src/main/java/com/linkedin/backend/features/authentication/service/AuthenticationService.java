...
public class AuthenticationService {
    ...
    public void sendEmailVerificationToken(String email) {
        ...
        if (user.isPresent() && !user.get().getEmailVerified()) {
            ...
            // Set token and expiry in the user entity
            user.get().setEmailVerificationToken(hashedToken);
            user.get().setEmailVerificationTokenExpiryDate(LocalDateTime.now().plusMinutes(durationInMinutes));
            userRepository.save(user.get());

            // Email subject
            String subject = "Email Verification - Welcome to Opportune!";

            // Long, polished email body
            String body = String.format(
                    "Welcome to Opportune – your gateway to meaningful professional connections and career growth!\n\n"
                            + "To unlock all the features of your account and start networking with like-minded professionals, "
                            + "we need to verify your email address. Please use the code below to complete your verification process:\n\n"
                            + "Verification Code: %s\n\n"
                            + "This code is valid for %s minutes. Make sure to use it before it expires to gain full access to "
                            + "Opportune's networking, mentorship, and opportunity discovery features.\n\n"
                            + "Once verified, you can:\n"
                            + "- Connect with professionals in your field\n"
                            + "- Discover and apply to exclusive opportunities\n"
                            + "- Showcase your skills and accomplishments\n"
                            + "- Participate in a vibrant community of innovators\n\n"
